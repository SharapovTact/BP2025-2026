...
FUNCTION WordCompare(Word1: STRING; Word2: STRING): INTEGER; {-1:W1<W2, 0:W1=W2, 1:W1>W2}
...
BEGIN {CharCompare}
  ...
  CharCompare := Equals;
  Pos := 1;
  WHILE (Pos <> Length(Alphabet)) AND (Compared = FALSE)
  DO
    BEGIN
...
FUNCTION WordCompare(Word1: STRING; Word2: STRING): INTEGER;
VAR
